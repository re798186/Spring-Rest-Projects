...
import in.reethu.request.PassengerInfo;
import in.reethu.response.Ticket;

@Service("service")
public class ERailClientApp {

	private static final String REST_END_URL = "http://localhost:8080/SpringRest-TicketBooking-ProviderApp/api/ticket/register";
	...
	public void invokeRestApi() {
		...
		body.setFirstName("Reethu");
		body.setLastName("Govind");
		body.setJourneyDate("22/06/2023");
		body.setFrom("bengaluru");
		body.setTo("kannur");
		body.setTrainNumber("BNG-CAN-1234");
